...
///
/// The values are part of the platform-specific [`asm/hwcap.h`][hwcap_link].
///
/// [hwcap_link]: https://github.com/torvalds/linux/blob/master/arch/arm64/include/uapi/asm/hwcap.h
